...
//给空间添加监听事件要实现的一些接口
public class CardsMove : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler,
    IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        //temp.x = Mathf.Clamp((offset + uguiPos).x, 0, Screen.width);
        //temp.y = Mathf.Clamp((offset + uguiPos).y, 0, Screen.height);
    ...
    //// 限制坐标范围
    //Vector2 DragRangeLimit(Vector2 pos)
    //{
